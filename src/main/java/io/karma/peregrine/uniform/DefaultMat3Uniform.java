...
import io.karma.peregrine.api.uniform.MatrixUniform.Mat3Uniform;
...
public final class DefaultMat3Uniform extends AbstractUniform<Matrix3f> implements Mat3Uniform {
    ...
    DefaultMat3Uniform(final String name, final Object defaultValue) {
        super(name);
        value.set(Requires.instanceOf(defaultValue, Matrix3fc.class, "Default matrix is not a float matrix"));
    }
