...
import io.karma.peregrine.api.uniform.VectorUniform.IVec4Uniform;
...
public final class DefaultIVec4Uniform extends AbstractUniform<Vector4i> implements IVec4Uniform {
    ...
    DefaultIVec4Uniform(final String name, final Object defaultValue) {
        super(name);
        value.set(Requires.instanceOf(defaultValue, Vector4ic.class, "Default value is not an int vector"));
    }
    ...
    public boolean equals(final Object obj) {
        if(!(obj instanceof IVec4Uniform other)) {
            return false;
        }
    ...
    public String toString() {
        return String.format("DefaultIVec4Uniform[name=%s,value=%s]", name, value);
    }
}
